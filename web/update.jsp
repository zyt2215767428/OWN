...
<div class="layui-container">
    <form class="layui-form" action="/updateUser" method="post">
        <div class="layui-form-item">
            <label class="layui-form-label">用户名编号</label>
            <div class="layui-input-block">
                <input type="text" name="id" value="${user.id}" readonly class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <input  type="hidden" id="rid" value="${user.role.id}"/>
            <div class="layui-input-block">
        ...
        $.ajax({
            ...
            success:function (data){
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    //因为是修改，所以需要选中角色信息
                    if($("#rid").val()==data[i].id){
                        html+="<option selected value='"+data[i].id+"'>"+data[i].rname+"</option>";
                    }else {
